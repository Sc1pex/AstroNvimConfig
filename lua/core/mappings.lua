...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>tr"] = { function() require("telescope").extensions.toggletasks.spawn() end, desc = "Run task" }
  maps.n["<leader>ts"] = { function() require("telescope").extensions.toggletasks.select() end, desc = "Select task" }
end
...
-- Debugging
maps.n["<F8>"] = { function() require("dap").continue() end, desc = "Debug continue" }
maps.n["<F9>"] = { function() require("dap").step_over() end, desc = "Debug step over" }
maps.n["<F10>"] = { function() require("dap").step_into() end, desc = "Debug step into" }
maps.n["<F11>"] = { function() require("dap").step_out() end, desc = "Debug step out" }
